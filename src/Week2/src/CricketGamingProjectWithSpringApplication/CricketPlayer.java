...
public class CricketPlayer extends Player {
    ...
    public CricketPlayer(String name, int age, String role, int totalRunsScored, int numberOfCenturies, int numberOfMatchesPlayed, double avgStrikeRate, String belongsToCountry) {
        super(name,age,role);
